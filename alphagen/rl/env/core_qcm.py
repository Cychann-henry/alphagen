# QCM 专用环境 Core：仅改用 config_qcm 的 MAX_EXPR_LENGTH，其余与 alphagen.rl.env.core 一致
# 使用方式：from alphagen.rl.env.core_qcm import AlphaEnvCoreQcm

from typing import Tuple, Optional
import gymnasium as gym
import math

from alphagen.config_qcm import MAX_EXPR_LENGTH
...
class AlphaEnvCoreQcm(gym.Env):
    """QCM 体系环境 Core：与 AlphaEnvCore 接口一致，仅使用 config_qcm 的表达式长度与常量。"""
    pool: AlphaPoolBase
    _tokens: List[Token]
